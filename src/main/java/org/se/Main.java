...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		// NounTerm t1 = TermVariations.createTerm(example.getNouns().get("Mann"), Gender.MALE, GrammaticalCase.DATIVE, Numerus.PLURAL, d);
		// System.out.println(t1);

		// NounTerm t2 = TermVariations.createTerm(example.getNouns().get("Frau"), Gender.FEMALE, GrammaticalCase.ACCUSATIVE, Numerus.PLURAL, d);
